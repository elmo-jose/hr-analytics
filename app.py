...
with st.expander("Project insights"):
    ...
    with d2:
        ...
        st.metric(label="Project ID with least hours dedicated to: ", value=proj['hours'].idxmin(),delta=-proj['hours'].min()) #project ID least worked on
        ...
        st.metric(label="Project ID with least check-ins: ", value=proj['count'].idxmin(),delta=-proj['count'].min()) #project id w/ least check-ins
